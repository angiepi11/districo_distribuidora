      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">informacion del producto</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <?php foreach ($productos as $producto): ?>
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
					...
					<img class="img-fluid" src="data:image/*;base64,<?= base64_encode($producto['imagen']) ?>" alt="<?= $producto['nombre'] ?>" width="400" height="350">
                    </a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h5><?= esc($producto['nombre']) ?></h5>
					<p class="price"><span style="font-size: 14px;">$<?= esc($producto['precio_actual']) ?></span></p>
                    ...
                    <div class="m-auto d-flex">
                          ...
                          <form method="POST" action="<?php echo base_url('aggcarrito');?>">
                                ...
                                <button type="submit" class="buy-now d-flex justify-content-center align-items-center mx-1" style=" background: #6cb66a; color: #241d1d;">
    <span><i class="ion-ios-cart"></i></span>Agregar al carrito
</button>
