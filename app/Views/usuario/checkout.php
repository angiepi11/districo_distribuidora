...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Districo</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	...
              	<a class="dropdown-item" href="<?php echo base_url().'lista';?>">lista de productos</a>
                <a class="dropdown-item" href="<?php echo base_url().'prounicos';?>">Productos unicos</a>
	          ...
	          <li class="nav-item cta cta-colored"><a href="<?php echo base_url().'carrito';?>" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
