...
<link rel="stylesheet" href="<?= base_url('css/css.css') ?>">
  ...
  <body class="goto-here">
	    <!-- informacion basica de la empresa, numero, correo, informacion destacada e importante, con fondo verde y letras blancas-->
	    ...
	    <!-- aqui empezamos en la barra de navegacion, donde principalmente se pone el enlace del incio de pagina en el nombre -->
    ...
    <!-- aqui empiezan las opciones de menu -->
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			 ...
			 <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">sobre nosotros</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="<?php echo base_url().'sobre';?>">sobre nosotros</a>
              	<a class="dropdown-item" href="<?php echo base_url().'contactanos';?>">contactanos</a>
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(images/imgfon1.png);">
	      ...
	      <div class="slider-item" style="background-image: url(images/imgfon2.png);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	...
	<form action="<?php echo base_url().'filtro';?>" method="post">
      <div class="container-fluid booking mt-5 pb-5">
          ...
          <div class="bg-light shadow" style="padding: 40px; max-width: 885px; margin: 0 auto;">
                  <div class="row align-items-center" style="min-height: 10px;">
                      <div class="col-md-10">
                          <div class="row">
                              <div class="col-md-3">
                                  <div class="mb-3 mb-md-0">
                                      <select class="custom-select px-4" name="productos" style="height: 47px; width:103%">
                                          <option selected>productos</option>
                                          <option value="1"> Todos los productos</option>
                                          <option value="2">repollo </option>
                                          <option value="3">berenjena</option>
                                          <option value="4">cebolla</option>
                                          <option value="5">perejil</option>
                                      </select>
                                  </div>
                              </div>
  
                              <div class="col-md-3"></div> <!-- Aquí añadí un espacio de 3 columnas -->
                              <div class="col-md-3">
                                  <div class="mb-3 mb-md-0">
                                   <select class="custom-select px-4" name="presupuesto" style="height: 47px; width:103% ">
                      ...
                      <div class="col-md-2">
                          ...
                          <button class="btn btn-primary btn-block" type="submit" style="height: 47px; margin-top: -2px; width:103%">Buscar</button>
...
>			<div class="container">
<div class="row no-gutters ftco-services" style="margin-top: -100px;"> <!-- Puedes ajustar el valor del margen superior según tus necesidades -->
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Tenemos para ti productos de calidad</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>atendemos a quejas y sugerencias 24/7 </span>
              </div>
            </div>      
          </div>
        </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="filtro.php" class="img-prod"><img class="img-fluid" src="images/product-1.jpg" alt="Colorlib Template">
